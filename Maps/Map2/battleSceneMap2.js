...
var resCorrecta = 0
var pregunta = 0
var promLength = problemasMap2.length
  
function createButtons(){
    vecProblema = []
    var azar = Math.floor(Math.random() * promLength)
    var contLength = problemasMap2[azar].length
    var resAleatoria = 0
    var elementoEliminado = 0
    var lengthAux = 0
    
    for(i=0; i<contLength; i++){
        vecProblema.push(problemasMap2[azar][i])
    }
...
function modifyButtons(){
    ...
    var contLength2 = problemasMap2[azar2].length
    var resAleatoria2
    ...
    for(i=0; i<contLength2; i++){
        vecProblema.push(problemasMap2[azar2][i])
    }
