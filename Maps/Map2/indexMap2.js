...
console.log('----------' + problemasMap2.length + '----------------------------')
...
for (let i = 0;  i < collisionsMap2.length; i+= 70){
    collisionsMap.push(collisionsMap2.slice(i, 70 + i))
}

const battleZonesMap = []
for (let i = 0;  i < battleZonesDataMap2.length; i+= 70){
    battleZonesMap.push(battleZonesDataMap2.slice(i, 70 + i))
}
...
image.src = '../../My Game Assets/Images/Bosque.png'

const foregroundImage = new Image()
foregroundImage.src = '../../My Game Assets/Images/foregroundMap2.png'
