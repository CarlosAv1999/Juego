...
var resCorrecta = 0
var pregunta = 0
var promLength = problemasMap3.length
  
function createButtons(){
    vecProblema = []
    var azar = Math.floor(Math.random() * promLength)
    var contLength = problemasMap3[azar].length
    var resAleatoria = 0
    var elementoEliminado = 0
    var lengthAux = 0
    
    for(i=0; i<contLength; i++){
        vecProblema.push(problemasMap3[azar][i])
    }
...
function modifyButtons(){
    ...
    var contLength2 = problemasMap3[azar2].length
    var resAleatoria2
    ...
    for(i=0; i<contLength2; i++){
        vecProblema.push(problemasMap3[azar2][i])
    }
