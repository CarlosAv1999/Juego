...
console.log('----------' + problemasMap3.length + '----------------------------')

canvas.width = 1024
canvas.height = 576

const collisionsMap = []
for (let i = 0;  i < collisionsMap3.length; i+= 80){
    collisionsMap.push(collisionsMap3.slice(i, 80 + i))
}

const battleZonesMap = []
for (let i = 0;  i < battleZonesDataMap3.length; i+= 80){
    battleZonesMap.push(battleZonesDataMap3.slice(i, 80 + i))
}
...
image.src = '../../My Game Assets/Images/MontanaFix.png'

const foregroundImage = new Image()
foregroundImage.src = '../../My Game Assets/Images/foregroundMap3.png'
